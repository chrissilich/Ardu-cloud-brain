const API_BASE = 'http://localhost:3000/'; // <button class="program" data-program-name="off">off</button>
...
programButtons.forEach(programButton => {
  programButton.addEventListener('click', () => {
    ...
    axios.get(API_BASE + 'program/' + programName).then(response => {
      // handle success
      console.log('SUCCESS');
...
colorSave.addEventListener('click', () => {
  ...
  axios.get(API_BASE + 'r/' + r).then(response => {
    // handle success
    console.log('SUCCESS');
    console.log(response.data);
  }).catch(error => {
  ...
  axios.get(API_BASE + 'g/' + g).then(response => {
    // handle success
    console.log('SUCCESS');
    console.log(response.data);
  }).catch(error => {
  ...
  axios.get(API_BASE + 'b/' + b).then(response => {
    // handle success
    console.log('SUCCESS');
    console.log(response.data);
  }).catch(error => {
